...
- [x] 2.3 Implementacja providera dla ogłoszeń bezpośrednich bez pośredników (`src/providers/direct.py` - Adresowo, Sprzedajemy, Lento) z odczytem żywych linków
...
- [x] 4.4 Przeprowadzenie uruchomienia na żądanie i weryfikacja wygenerowanego pliku historii z działającymi linkami i nowym układem
